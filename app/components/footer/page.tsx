export default function Footer() {
  return (
    <footer className="px-4 md:px-8 xl:px-12 pb-4 md:pb-6">
      <div className="border-t border-gray-200 pt-6 flex flex-col gap-1 md:flex-row md:items-end md:justify-between max-w-screen-xl mx-auto">
