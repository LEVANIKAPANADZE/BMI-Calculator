...
export default function Header() {
  ...
  return (
    <div className="px-4 md:px-8 xl:px-12 pt-4 md:pt-6">
      <header className="flex items-center justify-between px-4 md:px-6 h-14 md:h-16 bg-white border border-gray-200 rounded-2xl shadow-sm max-w-screen-xl mx-auto">
