export default function Footer() {
  return (
    <footer className="px-4 md:px-8 xl:px-12 pb-6 md:pb-8 mt-auto">
      <div className="border-t border-gray-200 dark:border-gray-800 pt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between max-w-screen-xl mx-auto">
        ...
        <small className="text-xs text-gray-400 dark:text-gray-500 md:text-right">
